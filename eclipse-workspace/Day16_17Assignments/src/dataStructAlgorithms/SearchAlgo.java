        ...
        do
        {
            ...
            switch (choice)
            {
                case 1:
                    ...
                    int arraySize=sf.inputInteger();
                    int a[]=sf.input1DArray(arraySize);
                    Arrays.sort(a);
                    sf.print1DArray(a);
                    System.out.println("Enter Key: ");
                    int position=sf.binarySearch(a,sf.inputInteger());
                ...
                case 2:
                    ...
                    int arraySize1=sf.inputInteger();
                    String b[]=sf.input1DStringArray(arraySize1);
                    Arrays.sort(b);
                    sf.print1DStringArray(b);
                    System.out.println("Enter Key: ");
                    int position1=sf.binarySearchString(b,sf.inputString());
                ...
                case 3:
                    ...
                    System.out.println("Enter size: ");
                    int arraySize5=sf.inputInteger();
                ...
                case 4 :
                    ...
                    System.out.println("Enter number of words to be sorted: ");
                    int arraySize4=sf.inputInteger();
                ...
                case 5:
                    ...
                    System.out.println("Enter size: ");
                    int arraySize2=sf.inputInteger();
                ...
                case 6:
                    ...
                    System.out.println("Enter number of words to be sorted: ");
                    int arraySize3=sf.inputInteger();
